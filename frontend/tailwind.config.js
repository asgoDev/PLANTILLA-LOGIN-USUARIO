  ...
  theme: {
    extend: {
      ...
      fontFamily: {
        ...
        'label-lg': ['var(--font-primary)', 'sans-serif'],
        'label-sm': ['var(--font-primary)', 'sans-serif'],
        'headline-lg': ['var(--font-primary)', 'sans-serif'],
        'body-lg': ['var(--font-primary)', 'sans-serif'],
        'body-md': ['var(--font-primary)', 'sans-serif'],
        'headline-md': ['var(--font-primary)', 'sans-serif'],
        'headline-sm': ['var(--font-primary)', 'sans-serif'],
        'headline-lg-mobile': ['var(--font-primary)', 'sans-serif'],
        'body-sm': ['var(--font-primary)', 'sans-serif'],
        'display-lg': ['var(--font-primary)', 'sans-serif'],
      },
      fontSize: {
